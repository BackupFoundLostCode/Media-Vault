...
To edit an entry, modify the desired fields in the provided form and confirm the changes by clicking “Change” in the corresponding window. After making changes, it is recommended to click “Reload” to refresh the list and display the updated data.
